...
import { CustomerNumericOnlyDirective } from './customer-numeric-only.directive';
...
describe('CustomerNumericOnlyDirective', () => {
    let fixture: ComponentFixture<TestComponent>;
    let inputEl: DebugElement;

    beforeEach(() => {
        TestBed.configureTestingModule({
        declarations: [TestComponent, CustomerNumericOnlyDirective],
        imports: [FormsModule]
        });
    ...
    it('should create an instance', () => {
        const directive = new CustomerNumericOnlyDirective();
