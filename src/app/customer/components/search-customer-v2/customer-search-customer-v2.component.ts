...
@Component({
  selector: 'app-customer-search-customer-v2',
  standalone: false,
  templateUrl: './customer-search-customer-v2.component.html',
  styleUrl: './customer-search-customer-v2.component.scss'
})
export class CustomerSearchCustomerV2Component implements OnInit {
  ...
  private setNumIdValidators(typeId: string): void {
    ...
    if (typeId === 'rfc') {
      ...
      numIdControl.setValidators([
        Validators.maxLength(13),
        Validators.pattern(CustomerREGEX.NIF_TIN_NSS_VALIDATION)
      ]);
    }
