...
// import { CustomerPpeInfoComponent } from './customer-ppe-info.component';
...
// import { CustomerModalFormService } from './../../../shared/services/customer-modal-form.service';
...
// describe('CustomerPpeInfoComponent', () => {
//   let component: CustomerPpeInfoComponent;
//   let fixture: ComponentFixture<CustomerPpeInfoComponent>;

//   beforeEach(async () => {
//     await TestBed.configureTestingModule({
//       declarations: [CustomerPpeInfoComponent, CustomerTableResultsComponent],
//       imports: [
//         CommonModule,
//         ReactiveFormsModule,
//         MatFormFieldModule,
...
//       ],
//       providers: [
//         { provide: CustomerModalFormService, useValue: mockModalFormService },
...
//         { provide: CustomerFamilyPPEService, useValue: mockFamilyPPEService },
//         { provide: CustomerDepPPEService, useValue: mockDepPPEService },
//         { provide: CustomerSocAssoPPEService, useValue: mockSocAssoPPEService },
//         { provide: CustomerPpeService, useValue: mockPpeService },
...
//     fixture = TestBed.createComponent(CustomerPpeInfoComponent);
...
// describe('CustomerPpeInfoComponent Delete', () => {
//   let component: CustomerPpeInfoComponent;
//   let fixture: ComponentFixture<CustomerPpeInfoComponent>;
...
//         { provide: CustomerDepPPEService, useValue: mockDepPPEService },
//         { provide: CustomerSocAssoPPEService, useValue: mockSocAssoPPEService },
//         { provide: CustomerPpeService, useValue: mockPpeServiceData },
//         { provide: UnsavedChangesService, useValue: mockUnsavedChangesService },
//         { provide: CustomerNotificationModalService, useValue: mockNotificationModalService },
//         { provide: CustomerFirstDataClientService, useValue: mockFirstDataClientService },
//         FormBuilder,
...
// describe('CustomerPpeInfoComponent - onSubmit', () => {
//   let component: CustomerPpeInfoComponent;
//   let fixture: ComponentFixture<CustomerPpeInfoComponent>;
//   const onSubmit = {
//     get: jasmine.createSpy().and.returnValue({
...
//         { provide: CustomerDepPPEService, useValue: mockDepPPEService },
//         { provide: CustomerSocAssoPPEService, useValue: mockSocAssoPPEService },
//         { provide: CustomerPpeService, useValue: onSubmit },
//         { provide: UnsavedChangesService, useValue: mockUnsavedChangesService },
//         { provide: CustomerNotificationModalService, useValue: mockNotificationModalService },
//         { provide: CustomerFirstDataClientService, useValue: mockFirstDataClientService },
//         FormBuilder,
...
//     component.profileForm.controls['customer-ppe'].setValue('');
//     component.onSubmit();
