...
import { CustomerDepPPEService } from './customer-dep-ppe.service';

describe('CustomerDepPPEService', () => {

  let service: CustomerDepPPEService;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [CustomerDepPPEService]
    });

    service = TestBed.inject(CustomerDepPPEService);
  });
  ...
  describe('add', () => {
    ...
    it('no agrega duplicados por rfc', () => {
  ...
  describe('update', () => {
    ...
    it('actualiza elemento existente', () => {
      const item = buildItem({ rfc: '1', firstName: 'A' });
      service.add(item);
  ...
  describe('clear', () => {
    ...
    it('limpia colección cuando hay datos', () => {
      service.add(buildItem());
    ...
    it('retorna true incluso si está vacío', () => {
      const result = service.clear();
