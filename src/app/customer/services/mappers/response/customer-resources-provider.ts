...
import { DataResResourceProvider, CustomerPpeRelative } from "../../../models/checkpoints/response/customer-resources-provider";
import { CustomerResourceProviderData } from "../../../models/customer-resource-provider";

export function mapToSignalResourceProvider(input: DataResResourceProvider): CustomerResourceProviderData{
  return {
    generalData: {
