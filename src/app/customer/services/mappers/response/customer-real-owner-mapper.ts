...
import { DataResRealOwner, CustomerPpeRelative } from '../../../models/checkpoints/response/customer-real-owner';
import { CustomerRealOwnerData } from '../../../models/customer-real-owner';

export function mapToSignalRealOwner(input: DataResRealOwner): CustomerRealOwnerData {
