...
import { DataResResourceProvider, CustomerPpeRelative } from "../../../../models/checkpoints/response/maintenance/customer-resources-provider";
import { CustomerResourceProviderData } from "../../../../models/customer-resource-provider";


export function mapToSignalResourceProviderMant(input: DataResResourceProvider): CustomerResourceProviderData{
  return {
    generalData: {
