...
export interface CustomerRealOwnerData {
  generalData: CustomerRealOwner;
  ppe: CustomerRealOwnerPPE;
...
export interface CustomerRealOwnerPPE {
  idM?: number;
  id?: number;
  ppe: boolean;
  tppe: string;
...
export interface DataRealOwnerClientFamilyPPE
  extends CustomerMinRealOwnerDataClient,
  CustomerPositionHeld {
  idM?: number;
  id?: string | number;
  idS?: string;
...
export interface CustomerMinRealOwnerDataClient {
  curp: string;
  foreignerWithoutCurp: boolean;
  rfc: string;
  firstName: string;
...
export interface CustomerRealOwnerPersonType {
  desPersonType: string;
  personTypeId: string;
}

export interface CustomerFinancialEntity {
  id: string;
  description: string;
}

export interface CustomerAccionariaEstructura {
  personTypeId: string;
  desPersonType: string;
}

export interface CustomerShareholderTablePF {
  tempId?: string;
  fullName: string;
  email: string;
  phone: number;
...
export const ACCIONARIA_ESTRUCTURAS: CustomerAccionariaEstructura[] = [
  {
    personTypeId: '1',
...
export const FINANCIAL_ENTITIES: CustomerFinancialEntity[] = [
...
export const REAL_OWNER_PERSON_TYPES: CustomerRealOwnerPersonType[] = [
...
export interface CustomerShareholderFormData {
  personType: 'PF' | 'PM';
...
export type RealOwnerData = CustomerRealOwnerData;
export type Address = CustomerAddress;
export type RealOwnerPPE = CustomerRealOwnerPPE;

export type MinRealOwnerDataClient = CustomerMinRealOwnerDataClient;
export type RealOwnerPersonType = CustomerRealOwnerPersonType;
export type FinancialEntity = CustomerFinancialEntity;
export type AccionariaEstructura = CustomerAccionariaEstructura;
export type ShareholderTablePF = CustomerShareholderTablePF;
export type ShareholderFormData = CustomerShareholderFormData;
