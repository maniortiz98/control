...
export interface CustomerInterviewData {
  id: number | null;
  date: string | null;
...
export interface CustomerInterviewDataId {
  id: number;
  LowRisk: {
    id: number;
  }
...
export type InterviewData = CustomerInterviewData;
export type InterviewDataId = CustomerInterviewDataId;
