import { CI_FamilyData, CI_PpeInformation } from "../../../../shared/models/customer";
...
import { Association, DataResPPE, EconomicDependent, FamilyData } from "../../../models/checkpoints/response/ppe";
