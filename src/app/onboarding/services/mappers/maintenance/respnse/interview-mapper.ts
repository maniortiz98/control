...
import { InterviewData } from "../../../../models/checkpoints/response/maintenance/interview";
...
export function mapResToPersonalInterview(
  ...
  return {
    ...
    isPFWithBusinessActivity:
      input.isPFWithBusinessActivity ?? false,
    lowRisk: {
    ...
    mediumRisk: {
      initialInvestmentInActinver: input.mediumRisk?.initialInvestmentInActinver ?? '',
      relationship: input.mediumRisk?.relationship?.toString() ?? '',
