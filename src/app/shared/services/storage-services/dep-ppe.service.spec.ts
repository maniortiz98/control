...
import { DepPPEService } from './dep-ppe.service';
import { DataClientDepPPE } from '../../../onboarding/models/client-data';

describe('DepPPEService', () => {
  let service: DepPPEService;

  beforeEach(() => {
    service = new DepPPEService();
  });
  ...
  it('should add a list of objects', () => {
    const dataList: DataClientDepPPE[] = [
      {
        rfc: '123',
        curp: '',
        foreignerWithoutCurp: false,
  ...
  it('should update an existing object', () => {
    ...
    service.add(data);
    const updatedData: DataClientDepPPE = {
      rfc: '123',
      curp: '',
      foreignerWithoutCurp: false,
      typeIden: '',
