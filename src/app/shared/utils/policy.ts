export type TriCountry = 'MX' | 'US' | 'OTRO';

export const norm = (v?: string): TriCountry => {
...
export interface PolicyResult {
  global: PolicyGlobal;
  byRow: Record<string, PolicyPerRow>;
}
...
export function computePolicy(
  ...
  const byRow: Record<string, PolicyPerRow> = {};
  rows.forEach((r) => {
