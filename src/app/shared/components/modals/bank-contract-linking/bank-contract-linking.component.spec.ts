...
import { BankContractLinkingComponent, Contract } from './bank-contract-linking.component';
...
describe('BankContractLinkingComponent', () => {
    let component: BankContractLinkingComponent;
    let fixture: ComponentFixture<BankContractLinkingComponent>;
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            declarations: [BankContractLinkingComponent],
            imports: [
                CommonModule,
                MatRadioModule,
                MatButtonModule,
        ...
        fixture = TestBed.createComponent(BankContractLinkingComponent);
