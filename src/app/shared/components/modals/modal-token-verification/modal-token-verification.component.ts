...
import { OtcSmsResponse } from '../../../../onboarding/models/otc-sms';
...
@Component({
  ...
  templateUrl: './modal-token-verification.component.html',
  styleUrl: './modal-token-verification.component.css'
})
export class ModalTokenVerificationComponent implements OnInit, AfterViewInit {
  ...
  readonly dialogRef = inject(MatDialogRef<ModalTokenVerificationComponent>);
  ...
  otcResponseSms = signal<OtcSmsResponse | null>(null);
  otcResponseEmail = signal<OtcMailResponse | null>(null);
